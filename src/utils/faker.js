...
const fakers = {
  fakeUsers() {
    const users = [
      { name: "Mertcan Yılmaz", gender: "male" },
      { name: "Bülent Demir", gender: "male" },
      { name: "Yunus Emre Aksu", gender: "male" },
      { name: "Samet Aktaş", gender: "male" },
      { name: "Ramazan Karadağ", gender: "male" },
      { name: "Rasim İpek", gender: "male" },
      { name: "Burak Pitt", gender: "male" },
      { name: "Ayşe Jolie", gender: "female" },
      { name: "Levent Deniz", gender: "male" },
      { name: "Tarkan Kaya", gender: "male" },
      { name: "Kemal Taş", gender: "male" },
      { name: "Ali Schwarzenegger", gender: "male" },
      { name: "Sami Stallone", gender: "male" },
      { name: "Zeynep Alpaslan", gender: "female" },
      { name: "Canan Sönmez", gender: "female" },
      { name: "Meryem Tekin", gender: "female" },
      { name: "Kemal Gürsoy", gender: "male" },
      { name: "Murat Demirci", gender: "male" },
      { name: "Mehmet Ertürk", gender: "male" },
      { name: "Erdem Yılmaz", gender: "male" },
      { name: "Baran Sönmez", gender: "male" },
      { name: "Ahmet Özdemir", gender: "male" },
      { name: "Elif Başaran", gender: "female" },
      { name: "Zeynep Aydın", gender: "female" },
      { name: "Deniz Arslan", gender: "female" },
      { name: "Merve Kaya", gender: "female" },
      { name: "Ali Deniz", gender: "male" },
      { name: "Kemal Eren", gender: "male" },
      { name: "Hasan Göker", gender: "male" },
      { name: "Selin Yılmaz", gender: "female" },
    ];
  ...
  fakeTimes() {
    const times = ["01:10", "05:09", "06:05", "03:20", "04:50", "13:00"];
