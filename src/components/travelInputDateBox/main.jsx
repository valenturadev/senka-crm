...
const TraveInputDateBox = ({ label, id, selectedDate, onChange }) => {
    return (
        <div className="relative flex flex-col">
            <label
                htmlFor={id}
                className={`absolute dark:text-white px-2 font-normal left-[7px] -top-[13.2px] dark:bg-[#232D45] bg-[#F1F5F9] text-gray-500 pointer-events-none transition-all duration-300 z-10`}
            >
                {label}
            </label>
            <DatePicker
