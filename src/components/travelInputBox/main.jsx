    ...
    return (
        <div className="relative">
            ...
            <input
                ...
                value={value}
                onChange={onChange}
                className={`block w-full ${classNa} px-4 py-2 border bg-[#F1F5F9] border-gray-500 rounded-xl focus:ring focus:ring-red-300 focus:outline-none focus:border-red-300 transition-all duration-300`}
            />
        </div>
    );
};
